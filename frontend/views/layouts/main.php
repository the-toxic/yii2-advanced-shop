        ...
        <div class="container">
            ...
            <div id="top-links" class="nav pull-right">
                <ul class="list-inline">
                    ...
                    <li class="dropdown">
                        <a href="/index.php?route=account/account" title="Кабинет" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md">Кабинет</span> <span class="caret"></span>
                        </a>
                                    ...
                                    <tr>
                                        <td class="text-center"><a
                                                    href="/index.php?route=product/product&amp;product_id=30"><img
                                                        src="http://static.toxic.pro/cache/products/canon_eos_5d_1-47x47.jpg"
                                    ...
                                    <tr>
                                        <td class="text-center"><a
                                                    href="/index.php?route=product/product&amp;product_id=40"><img
                                                        src="http://static.toxic.pro/cache/products/iphone_1-47x47.jpg"
