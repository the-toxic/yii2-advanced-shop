...
<div class="user-view">
    ...
    <p>
        <?php if ($product->isActive()): ?>
            <?= Html::a('Выключить', ['draft', 'id' => $product->id], ['class' => 'btn btn-primary', 'data-method' => 'post']) ?>
        <?php else: ?>
            <?= Html::a('Включить', ['activate', 'id' => $product->id], ['class' => 'btn btn-success', 'data-method' => 'post']) ?>
        <?php endif; ?>
